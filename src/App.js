...
class App extends React.Component {
  ...
  render() {
    return (
      <div className="app">
        <Menu tittle="React-Books" onsearch={this.onSearch} onadd={this.addItem} />
         <List items={this.state.books} items={this.state.copyBooks} onremove={this.remove} onupdaterating={this.updateRating}/>
      </div>
    );
  }
}
